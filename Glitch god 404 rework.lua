...
local MobilePlayer = false


local SpawnPoint = Instance.new("Part")
SpawnPoint.Anchored = true
SpawnPoint.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
...
game.Players:Chat(("ACT = [TELEPORT-TO-ATrain]"))
	...
	mouse.KeyDown:Connect(function(k) 
		if k == "g" then
            ...
            Anim.AnimationId = "rbxassetid://11273021696"-- 15579292670
            local k = game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(Anim)
            k:Play()
            k:AdjustSpeed(1)
            wait(23)
            local Anim = Instance.new("Animation")
            Anim.AnimationId = "rbxassetid://11273005728" --  15579295876
            local k = game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(Anim)
            k:Play()
            k:AdjustSpeed(1)
            wait(10)
